...
if ( function_exists('childtheme_override_access') )  {
    ...
    <div id="access">
    	...
    	<div class="skip-link"><a href="#content" title="<?php esc_attr_e( 'Skip navigation to the content', 'datse-multimedia-base' ); ?>"><?php _e('Skip to content', 'thematic'); ?></a></div><!-- .skip-link -->
